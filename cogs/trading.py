...
class Trading(commands.Cog):
    def __init__(self, bot: commands.Bot):
        self.bot = bot
        # Active trade sessions: { user_id: { "offer_items": [...],
        #                                      "offer_cash": int,
        #                                      "counter_items": [...],
        #                                      "counter_cash": int } }
        self.trades = {}
        # Load values from /home/container/cogs/values.json
        ...
        if os.path.exists(values_path):
            ...
            self.values_data = {}
        # Collect all item names for autocomplete
        self.all_items = []
    ...
    # Command Groups as Class Attributes 
    ...
    async def trade_end(self, interaction: discord.Interaction):
        ...
        # Send ANSI formatted code block after the embed
